      ...
      <section className="pt-36 pb-20 px-4 sm:px-6 max-w-5xl mx-auto">
        <div className="text-center max-w-3xl mx-auto mb-12">
          ...
          <h1 className="text-3xl sm:text-5xl font-black uppercase tracking-tight mb-4">
            Submit Your Idea: <span className="text-transparent bg-clip-text bg-gradient-to-r from-white via-[#93c5fd] to-[#0052FF]">Build for the North.</span>
          </h1>
          <p className="text-slate-300 text-sm sm:text-base font-light leading-relaxed">
            A three-day October 2026 final build sprint and demonstration for qualified DigiNorth BuildLab teams in Kaduna, Northern Nigeria.
          </p>
        </div>
